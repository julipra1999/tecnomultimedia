...
//------------------------------------------ESTADOS
 if(estado.equals("HyG") ) {
   ...
   image (ocho, 0, 0);
    ...
    textAlign(CENTER);
    fill(0);
    text("LOGRARON ENCONTRAR A UN POLICIA EN EL\n BOSQUE, Y ÉSTE LE DIJO: '¡NO SE PREOCUPEN! YA LOS HEMOS CAPTURADO.\n AHORA VAMOS, LOS LLEVO A SU CASA, QUE ES MUY PELIGROSO EL BOSQUE EN ESTAS HORAS!'", 400, 25);
    fill(#df8278);
    rect(350, 500, 100, 50);
    textSize(17);
    textAlign(CENTER);
